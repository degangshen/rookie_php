...
class DooSqlMagic {
   ...
   /* public function loadModel($className, $createObj=false){
    ...
    public function connect()
    {
        ...
        {
            throw new Rookie_Exception('Failed to open the PDO DB connection');
        }
    }
    ...
    /**
     * 执行一个查询到所连接的数据库
     * @param string $query SQL查询准备好的声明
     * @param array $param 在准备好的SQL中使用的值
     * @return PDOStatement
     */
    ...
    */
    ...
    /**
     * 查找记录及其相关模型。关系搜索。 (Prepares and execute the SELECT statements)
     * @param mixed $model The model class name or object to be select.
